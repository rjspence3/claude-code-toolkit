...
1. Write a handoff document using the /handoff format. Save it to `HANDOFF-{YYYY-MM-DD-HHMM}.md` in the current directory (use actual current date/time — never `HANDOFF.md`).
